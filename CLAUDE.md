...
Briefing pro každou novou Claude Code / Claude CLI session v tomto repu.
...
**Beacon** — white-label SDLC monitoring dashboard. Pilotní zákazník: ČEPS.
...
| Mock providers (17 ks) | [src/lib/integrations/mock.ts](src/lib/integrations/mock.ts) |
...
| Admin Branding (color picker, 5 stylů) | [src/app/(dashboard)/admin/branding/page.tsx](src/app/(dashboard)/admin/branding/page.tsx) |
...
vybere 1 z 5 vizuálních stylů (Solid Flat / Linear Gradient / Mesh
Aurora / Glassmorphism / High Contrast).

## Roadmap (kde jsme)

| Vlna | Stav |
|---|---|
| 1 — SDLC reorg + Postgres | reorg ✅, Postgres ⬜ |
| 2 — Visual (3 barvy + 5 stylů + persistence) | UI ✅, persistence 🔴 (read-only fs) |
| 3 — DORA + Quality gates | ⬜ |
